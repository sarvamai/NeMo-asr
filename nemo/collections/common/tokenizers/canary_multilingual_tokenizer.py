...
class CanaryMultilingualTokenizer(AggregateTokenizer):
    """
    ...
    def _text_to_ids_maybe_with_timestamps(self, text_no_eos, lang_id) -> list[int]:
        ...
        if lang_id in ['as', 'bn', 'brx', 'doi', 'en', 'gu', 'hi', 'kn', 'ks', 'kok', 'mai', 'ml', 'mni', 'mr', 'ne', 'od', 'pa', 'sa', 'sat', 'sd', 'ta', 'te', 'ur']:
...
def _map_canary1_to_canary2_lang(lang: str, available_langs: list[str]) -> str:
    ...
    if lang in ['as', 'bn', 'brx', 'doi', 'en', 'gu', 'hi', 'kn', 'ks', 'kok', 'mai', 'ml', 'mni', 'mr', 'ne', 'od', 'pa', 'sa', 'sat', 'sd', 'ta', 'te', 'ur']:
        return 'multilingual'
